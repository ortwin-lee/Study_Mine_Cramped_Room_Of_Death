...
export default class IdleSubStateMachine extends DirectionSubStateMachine {
    constructor(fsm: StateMachine) {
        ...
        this.stateMachines.set(DIRECTION_ENUM.BOTTOM, new State(fsm, `${PREFIX_URL}/${BASE_URL}/top/${BASE_URL}`));
        this.stateMachines.set(DIRECTION_ENUM.LEFT, new State(fsm, `${PREFIX_URL}/${BASE_URL}/left/${BASE_URL}`));
        this.stateMachines.set(DIRECTION_ENUM.RIGHT, new State(fsm, `${PREFIX_URL}/${BASE_URL}/left/${BASE_URL}`));
    }
}
